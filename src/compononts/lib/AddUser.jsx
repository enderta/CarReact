                    ...
                    <div className="col-md-6 offset-md-3">
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="full_name" name="full_name" value={full_name} onChange={(e) => setFullName(e.target.value)} />
                                                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="user_group_id" name="user_group_id" value={user_group_id} onChange={(e) => setUserGroupId(e.target.value)} />
                            </div>
                            <div className="form-group">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" className="form-control" id="start_date" name="start_date" value={start_date} onChange={(e) => setStartDate(e.target.value)} />
                            </div>
                            <div className="form-group">

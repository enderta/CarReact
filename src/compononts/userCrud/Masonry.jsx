    ...
    return (
        <div>
                ...
                <article>
                    ...
                    <p>
                        In the real world, you don't know how long the content will be. Writers
                        will write what they need. Photos will be cropped to the shape that they
                        should be. That's good. Make a system that allows this. You want it to be
                        flexible and robust.
                    </p>
                </article>
                <article>
                ...
                <article>
                    ...
                    <h3>
                        3) Some Headlines Can Sometimes Be Quite Long, Because It Takes Time to
                        Make A Point
                    </h3>
                    <p>
                ...
                <article>
                    ...
                    <h3>
                        4) Also, Why Are We Using Fake Content? Let's Make Some Real-ish Content.
                    </h3>
                    <p>
                        By using real content, we can see the variation inherent in what this site
                        might present. And we can design for those real world needs.
                    </p>
                </article>
                <article>
                ...
                <article>
                    ...
                    <p>
                        That's because floats are really crap at handling layout. We've been using
                        a screwdriver as a hammer. It sort of works, but badly.
                    </p>
                </article>
                <article>
                ...
                <article>
                    ...
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec a diam
                        lectus. Sed sit amet ipsum mauris tindunt.
                    </p>
                </article>
                <article>
                    ...
                    <p>
                        Always three lines of text, which fits exactly in the available space.
                        Describing where you will go when you click.
                    </p>
                </article>
                <article>
